...
const CreatePost = ({setShowModal=(e:boolean)=>e }) => {
    return (
        <div className='bg-gray-50 p-4 rounded-md'>
            <div className='flex gap-4 mb-4'>
                ...
                <button onClick={()=>setShowModal(true)} className='bg-gray-100 flex-grow rounded-full hover:bg-gray-200'>what is in your mind today</button>
            </div>
            <hr />
            <div onClick={()=>setShowModal(true)} className='mt-4 grid grid-cols-3 gap-2'>
